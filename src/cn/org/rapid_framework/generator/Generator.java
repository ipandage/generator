...
public class Generator implements GeneratorConstants {
	...
	private String removeExtensions = GeneratorProperties.getProperty(GENERATOR_REMOVE_EXTENSIONS,".ftl");
	private boolean isCopyBinaryFile = true;
	
	private String includes = GeneratorProperties.getProperty(GENERATOR_INCLUDES); 
	private String excludes = GeneratorProperties.getProperty(GENERATOR_EXCLUDES); 
